  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR operations with HR Management System - your one-stop solution for employee data, payrolls, time tracking, vacations, and performance evaluations."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR operations with HR Management System - your one-stop solution for employee data, payrolls, time tracking, vacations, and performance evaluations.`}
            </Text>
            <Box
